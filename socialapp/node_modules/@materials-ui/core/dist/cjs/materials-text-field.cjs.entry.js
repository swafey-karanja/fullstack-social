...
const TextField = class {
    constructor(hostRef) {
        ...
        this.trailingIconPress = index.createEvent(this, "trailingIconPress", 7);
        this.leadingIconPress = index.createEvent(this, "leadingIconPress", 7);
    }
    componentWillLoad() {
        if (!this.value) {
            this.value = '';
    ...
    componentDidLoad() {
        ...
        this.mdcTextFieldHelperText = new index$1.MDCTextFieldHelperText(this.helperTextEl);
        ...
        if (this.outlined) {
            ...
            component$2.MDCLineRipple.attachTo(this.lineRippleEl);
        }
        if (this.leadingIcon && this.leadingIconPress) {
            index$1.MDCTextFieldIcon.attachTo(this.host.shadowRoot.querySelector('.materials-leading-icon'));
        }
        if (this.trailingIcon && this.trailingIconPress) {
            index$1.MDCTextFieldIcon.attachTo(this.host.shadowRoot.querySelector('.materials-trailing-icon'));
        }
    }
    getClasses() {
        return {
    ...
    render() {
        return (index.h(index.Host, { class: { 'materials-text-field--dense': this.dense } }, index.h("div", { style: { 'width': this.width ? (this.width + 'px') : '100%' }, class: this.getClasses(), ref: mdcTextField => this.textFieldEl = mdcTextField }, this.leadingIcon &&
            index.h("i", { class: "materials-leading-icon material-icons mdc-text-field__icon", title: this.leadingIconTitle, onClick: (ev) => this.leadingIconPress.emit(ev), tabindex: "0", role: "button" }, this.leadingIcon), index.h("input", { id: "my-text-field", class: { 'mdc-text-field__input': true, 'hide-native-clear': this.hideNativeClear, 'mdc-text-field--overflow-elipsis': this.overflow }, type: this.type, pattern: this.pattern, value: this.value, disabled: this.disabled, required: this.required, readonly: this.readonly, name: this.name, maxlength: this.maxlength, ref: el => this.inputEl = el, onInput: (ev) => {
                this.value = ev.target.value;
                this.input.emit(ev);
            }, onChange: (ev) => this.change.emit(ev) }), this.trailingIcon &&
            index.h("i", { onClick: (ev) => this.trailingIconPress.emit(ev), class: "materials-trailing-icon material-icons mdc-text-field__icon", title: this.trailingIconTitle, tabindex: "0", role: "button" }, this.trailingIcon), this.outlined ?
            index.h("div", { class: "mdc-notched-outline", ref: notchedOutlineEl => this.notchedOutlineEl = notchedOutlineEl }, index.h("div", { class: "mdc-notched-outline__leading" }), index.h("div", { class: "mdc-notched-outline__notch" }, this.label && index.h("label", { class: this.getLabelClasses(), ref: el => this.floatingLabelEl = el }, this.label)), index.h("div", { class: "mdc-notched-outline__trailing" }))
            : this.label && index.h("label", { class: this.getLabelClasses(), ref: el => this.floatingLabelEl = el }, this.label), this.outlined ? '' : index.h("div", { class: "mdc-line-ripple", ref: el => this.lineRippleEl = el })), index.h("div", { class: "mdc-text-field-helper-line" }, index.h("div", { id: "helper-text", class: { 'mdc-text-field-helper-text': true }, "aria-hidden": "true", ref: el => this.helperTextEl = el }))));
    }
...
exports.materials_text_field = TextField;
