...
const Datepicker = class {
    constructor(hostRef) {
        ...
        this.dateSelectedUpdate = index.createEvent(this, "dateSelectedUpdate", 7);
    }
    componentWillLoad() {
    ...
    componentDidLoad() {
        Array.from(this.host.shadowRoot.querySelectorAll('.mdc-ripple-surface')).forEach((elem) => {
            component$1.MDCRipple.attachTo(elem);
        });
    }
    ...
    getClasses(day, index) {
        const classes = {
            ...
            'in-selected-range': utils.isInDateRange(day, this.dateRange.start, this.dateRange.end) && !this.isSameDate(),
        };
        return classes;
    }
    isInMonth(day, week) {
    ...
    render() {
        return (index.h("div", { class: "month-navigator mdc-typography" }, this.yearPicker &&
            index.h("div", { class: "year-picker" }, index.h("materials-icon-button", { dense: true, icon: "chevron_left", title: "Ann\u00E9e pr\u00E9c\u00E9dente", onClick: () => this.addYear(-1) }), utils.capitalizeFirstLetter(this.currentMonth.toLocaleString('fr-fr', { year: 'numeric' })), index.h("materials-icon-button", { dense: true, icon: "chevron_right", title: "Ann\u00E9e suivant", onClick: () => this.addYear(1) })), this.monthPicker &&
            index.h("div", { class: "month-picker" }, index.h("materials-icon-button", { dense: true, icon: "chevron_left", title: "Mois pr\u00E9c\u00E9dent", onClick: () => this.addMonth(-1) }), utils.capitalizeFirstLetter(this.currentMonth.toLocaleString('fr-fr', { month: 'long', year: this.yearPicker ? undefined : 'numeric' }))
            /**If yearPicker false display year next to month */ , index.h("materials-icon-button", { dense: true, icon: "chevron_right", title: "Mois suivant", onClick: () => this.addMonth(1) })), index.h("div", { class: "week-overview" }, index.h("span", { class: "day-name", title: "Lundi" }, "L"), index.h("span", { class: "day-name", title: "Mardi" }, "M"), index.h("span", { class: "day-name", title: "Mercredi" }, "M"), index.h("span", { class: "day-name", title: "Jeudi" }, "J"), index.h("span", { class: "day-name", title: "Vendredi" }, "V"), index.h("span", { class: "day-name", title: "Samedi" }, "S"), index.h("span", { class: "day-name", title: "Dimanche" }, "D")), this
            .getDaysOfMonth()
            .map((week, index$1) => index.h("div", { class: "week-overview" }, week.map(day => {
            return (index.h("a", { class: this.getClasses(day, index$1), onClick: () => {
                    this.dateSelectedUpdate.emit(day);
                } }, index.h("div", { class: { 'day-detail': true }, "data-datepicker": day.toJSON() }, day.getDate())));
        }))), index.h("div", { class: "actions" }, this.nullable &&
            index.h("materials-button", { outlined: true, block: true, dense: true, onClick: () => {
                    this.setDateSelected(null);
                    this.dateSelectedUpdate.emit(null);
                } }, "Vider"), this.todayPicker &&
            index.h("materials-button", { block: true, dense: true, onClick: () => {
...
exports.materials_card = Card;
exports.materials_datepicker = Datepicker;
