...
const Drawer = class {
    ...
    componentDidUpdate() {
        this.mdcDrawer = index$2.MDCDrawer.attachTo(this.host.shadowRoot.querySelector('.mdc-drawer'));
    }
    getDrawerClasses() {
        return {
            'mdc-drawer': true,
    ...
    render() {
        return ([
            index.h("aside", { class: this.getDrawerClasses() }, index.h("div", { class: "mdc-drawer__content" }, index.h("nav", { class: "mdc-list" }, this.items.map(item => {
...
exports.materials_drawer = Drawer;
