...
const Menu = class {
    ...
    componentDidLoad() {
        this.mdcMenuEl = new component$3.MDCMenu(this.menuEl);
    }
    async setPosition(position) {
        this.mdcMenuEl.setAnchorCorner(component$3.Corner[position]);
    }
