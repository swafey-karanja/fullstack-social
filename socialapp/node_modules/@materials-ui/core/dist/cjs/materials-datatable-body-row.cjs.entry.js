...
const DatatableBodyRow = class {
    ...
    render() {
        return index.h(index.Host, { class: {
            ...
            }, onClick: () => this.handleClick() }, index.h("div", { class: "container" }, index.h("div", { class: "mdc-ripple-surface mdc-ripple-surface--primary" }), this.expendable &&
            index.h("materials-icon-button", { dense: true, icon: this.expended ? 'arrow_drop_down' : 'arrow_right', onClick: (e) => this.toggleExpendable(e) }), this.selectable &&
            index.h("materials-checkbox", { class: "selection-checkbox", color: "primary", onChange: () => {
                    this.selected = !this.selected;
                }, onClick: (e) => e.stopPropagation(), checked: this.selected }), index.h("slot", null)), index.h("div", { class: "expendable-content" }, index.h("slot", { name: "expendable-content" })));
    }
...
exports.materials_datatable_body_row = DatatableBodyRow;
