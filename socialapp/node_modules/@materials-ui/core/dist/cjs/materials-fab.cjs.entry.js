...
const Fab = class {
    ...
    componentDidLoad() {
        component$1.MDCRipple.attachTo(this.host.shadowRoot.querySelector('.mdc-fab'));
    }
    renderIcon() {
        return this.icon ? (index.h("materials-icon", { name: this.icon })) : null;
    }
    render() {
        return (index.h("button", { class: { 'mdc-fab': true, 'mdc-fab--extended': !!this.label, 'mdc-fab--mini': this.size === 'small', 'mdc-fab--exited': this.hidden } }, this.icon && index.h("span", { class: "mdc-fab__icon material-icons" }, this.renderIcon()), this.label && index.h("span", { class: "mdc-fab__label" }, this.label)));
    }
