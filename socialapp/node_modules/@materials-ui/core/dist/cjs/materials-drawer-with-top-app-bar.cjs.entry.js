...
require('./index-e6bd8cce.js');
const index$2 = require('./index-3033fcff.js');
require('./component-9b142814.js');
require('./ponyfill-32fd2054.js');
const index$3 = require('./index-80f7c40d.js');

const DrawerWithTopAppBar = class {
    constructor(hostRef) {
    ...
    async componentDidLoad() {
        if (!this.drawer) {
            this.drawer = index$2.MDCDrawer.attachTo(this.host.shadowRoot.querySelector('.mdc-drawer'));
            this.drawer.open = this.open;
            const topAppBar = index$3.MDCTopAppBar.attachTo(this.host.shadowRoot.getElementById('app-bar'));
