...
/*
 Stencil Runtime v0.0.0-dev.20191211000719 | MIT Licensed | https://stenciljs.com
 */
let scopeId;
let contentRef;
let hostTagName;
    ...
    if ( (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if ( !styles.has(scopeId) && Cstr.style) {
            ...
            if ( cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await new Promise(function (resolve) { resolve(require('./shadow-css-6f46c37c.js')); }).then(m => m.scopeCss(style, scopeId, false));
            }
...
/*
 Stencil Client Platform v0.0.0-dev.20191211000719 | MIT Licensed | https://stenciljs.com
 */
...
const patchEsm = () => {
    ...
    if ( !(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return new Promise(function (resolve) { resolve(require('./css-shim.0369294f-2e43de32.js')); }).then(() => {
...
const patchBrowser = async () => {
    ...
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('index-c3bf379a.js', document.baseURI).href));
    ...
    if (importMeta !== '') {
        ...
        if (!window.customElements) {
            // @ts-ignore
            await new Promise(function (resolve) { resolve(require('./dom.15476383-9236c592.js')); });
        }
