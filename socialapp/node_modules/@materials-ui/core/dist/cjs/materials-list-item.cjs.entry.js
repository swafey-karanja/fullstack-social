...
const ListItem = class {
    ...
    componentDidLoad() {
        ...
        component$1.MDCRipple.attachTo(this.host.shadowRoot.querySelector('.mdc-list-item'));
    }
    getClasses() {
        return {
            'mdc-typography': true,
    ...
    render() {
        return (index.h(index.Host, { onClick: () => this.handleClick() }, index.h("li", { class: this.getClasses(), style: this.setHeight(), role: this.role, tabindex: this.disabled ? -1 : 0, "aria-disabled": this.disabled }, index.h("div", { class: "mdc-list-item__graphic", style: this.itemStartStyle }, index.h("slot", { name: "item-start" })), this.label && index.h("label", { class: { 'gmv-label-nowrap': !this.textWrap }, title: this.label }, this.label), index.h("slot", null), index.h("div", { class: "mdc-list-item__meta", style: this.itemEndStyle }, index.h("slot", { name: "item-end" })))));
    }
...
exports.materials_list_item = ListItem;
