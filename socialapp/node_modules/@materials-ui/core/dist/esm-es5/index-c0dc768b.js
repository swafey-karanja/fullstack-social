    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, import('./shadow-css-e6f25667.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
            case 3:
                style_1 = _a.sent();
                _a.label = 4;
            case 4:
...
var connectedCallback = function (elm) {
    if ((plt.$flags$ & 1 /* isTmpDisconnected */) === 0) {
        ...
        if (cmpMeta_1.$listeners$) {
            // initialize our event listeners on the host element
            // we do this now so that we can listening to events that may
            // have fired even before the instance is ready
            hostRef_1.$rmListeners$ = addEventListeners(elm, hostRef_1, cmpMeta_1.$listeners$);
        }
        if (!(hostRef_1.$flags$ & 1 /* hasConnected */)) {
            ...
            if (cmpMeta_1.$members$) {
                Object.entries(cmpMeta_1.$members$).forEach(function (_a) {
                    var memberName = _a[0], memberFlags = _a[1][0];
...
var patchEsm = function () {
    ...
    if (!(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import('./css-shim.0369294f-44aa0d9b.js').then(function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                // @ts-ignore
                return [4 /*yield*/, import('./dom.15476383-c7778c20.js')];
            case 2:
                // @ts-ignore
                _a.sent();
                _a.label = 3;
