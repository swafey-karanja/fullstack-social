...
import './index-0d98f647.js';
import { M as MDCDrawer } from './index-fefe7b63.js';
import './component-e22d7bf7.js';
import './ponyfill-f805c928.js';
import { M as MDCTopAppBar } from './index-4fadbdc3.js';
var DrawerWithTopAppBar = /** @class */ (function () {
    ...
    class_1.prototype.componentWillLoad = function () {
        ...
        new MutationObserver(function (mutationsList, _observer) {
            for (var _i = 0, mutationsList_1 = mutationsList; _i < mutationsList_1.length; _i++) {
                var mutation = mutationsList_1[_i];
                if (mutation.type === 'childList') {
                    _this.initActions();
                    _this.initDrawerItems();
                }
            }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (!this.drawer) {
                    ...
                    topAppBar = MDCTopAppBar.attachTo(this.host.shadowRoot.getElementById('app-bar'));
    ...
    class_1.prototype.renderAppBar = function () {
        ...
        return (h("header", { class: classes, id: "app-bar" }, h("div", { class: "mdc-top-app-bar__row" }, h("section", { class: "mdc-top-app-bar__section mdc-top-app-bar__section--align-start" }, h("a", { class: "demo-menu material-icons mdc-top-app-bar__navigation-icon" }, "menu"), h("span", { class: "mdc-top-app-bar__title" }, this.appBarTitle)), h("section", { class: "mdc-top-app-bar__section mdc-top-app-bar__section--align-end", role: "toolbar" }, this.actions.map(function (a) { return h("a", { href: "#", onClick: function () { return a.click(); }, class: "material-icons mdc-top-app-bar__action-item", "aria-label": a.title, title: a.title }, a.icon); })))));
    };
    class_1.prototype.renderDrawerItem = function (item) {
        return h("a", { class: {
                'mdc-list-item': true,
                'mdc-list-item--activated': item.activated
            }, href: item.targetUrl, onClick: function (e) { item.TriggerPress(e); }, "aria-current": "page" }, item.icon && h("i", { class: "material-icons mdc-list-item__graphic", "aria-hidden": "true" }, item.icon), h("span", { class: "mdc-list-item__text" }, item.label));
    };
    class_1.prototype.renderModal = function () {
        var _this = this;
        return [
            this.renderAppBar(),
            h("aside", { class: "mdc-drawer mdc-drawer--modal" }, h("div", { class: "mdc-drawer__content" }, h("nav", { class: "mdc-list" }, this.items.map(function (item) { return _this.renderDrawerItem(item); })))),
            h("div", { class: "mdc-drawer-scrim" }),
            h("div", null, h("slot", { name: "main" }))
        ];
    };
    class_1.prototype.renderFull = function () {
        var _this = this;
        return [
            h("aside", { class: "mdc-drawer mdc-drawer--dismissible" }, h("div", { class: "mdc-drawer__content" }, h("div", { class: "mdc-list" }, this.items.map(function (item) { return _this.renderDrawerItem(item); })))),
            h("div", { class: "mdc-drawer-app-content" }, this.renderAppBar(), h("main", { class: "main-content", id: "main-content" }, h("div", { class: "mdc-top-app-bar--fixed-adjust" }, h("slot", { name: "main" }))))
        ];
    };
    class_1.prototype.renderBelow = function () {
        var _this = this;
        return [
            this.renderAppBar(),
            h("aside", { class: "mdc-drawer mdc-drawer--dismissible mdc-top-app-bar--fixed-adjust" }, h("div", { class: "mdc-drawer__content" }, h("div", { class: "mdc-list" }, this.items.map(function (item) { return _this.renderDrawerItem(item); })))),
            h("div", { class: "mdc-drawer-app-content mdc-top-app-bar--fixed-adjust" }, h("main", { class: "main-content", id: "main-content" }, h("slot", { name: "main" })))
        ];
    };
