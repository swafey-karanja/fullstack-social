import { r as registerInstance, h, g as getElement, c as createEvent } from './index-c0dc768b.js';
import { i as isInDateRange, c as capitalizeFirstLetter } from './utils-df40b490.js';
...
var Card = /** @class */ (function () {
    ...
    Card.prototype.componentWillLoad = function () {
        var _this = this;
        Array.from(this.host.querySelectorAll('materials-card-action')).forEach(function (action, _index, array) {
            if (action.icon) {
                _this.actionIcons.push(action);
            }
            else {
                _this.actionButtons.push(action);
            }
            _this.fullBleedAction = action.fullBleed;
...
var Datepicker = /** @class */ (function () {
    function Datepicker(hostRef) {
        ...
        this.dateSelectedUpdate = createEvent(this, "dateSelectedUpdate", 7);
    }
    Datepicker.prototype.componentWillLoad = function () {
        this.dateSelected = this.isValidDate(this.dateSelected);
        this.dateSelectedClick(this.dateSelected);
    };
    Datepicker.prototype.componentDidLoad = function () {
        Array.from(this.host.shadowRoot.querySelectorAll('.mdc-ripple-surface')).forEach(function (elem) {
            MDCRipple.attachTo(elem);
        });
    };
    Datepicker.prototype.dateSelectedClick = function (date, old) {
        if (date) {
    ...
    Datepicker.prototype.isValidDate = function (d) {
        var dateParse = Date.parse(d);
        return isNaN(dateParse) ? new Date() : new Date(dateParse);
    };
    Datepicker.prototype.addYear = function (nb) {
        var newDate = new Date(this.currentMonth);
        newDate.setFullYear(newDate.getFullYear() + nb);
        this.currentMonth = newDate;
    };
    Datepicker.prototype.addMonth = function (nb) {
        // setMonth does not trigger update of the State property, we have to reassign
        var newDate = new Date(this.currentMonth);
        newDate.setMonth(newDate.getMonth() + nb);
        this.currentMonth = newDate;
    };
    Datepicker.prototype.addDays = function (date, days) {
        var result = new Date(date);
        result.setDate(result.getDate() + days);
        return result;
    };
    Datepicker.prototype.setDateSelected = function (date) {
        if (date) {
            date.setHours(0, 0, 0, 0);
        }
        this.dateSelected = date;
    };
    Datepicker.prototype.startOfWeek = function (d) {
        d = new Date(d);
        var day = d.getDay();
    ...
    Datepicker.prototype.getDaysOfMonth = function () {
        var days = [];
        var firstDate = new Date(this.currentMonth.getTime());
        ...
        for (var i = 0; i < 41; i++) { // 41 = 6*7 -1 to get 6 weeks
            var day = new Date(new Date(firstDate.getTime()).setHours(0, 0, 0, 0));
    ...
    Datepicker.prototype.getClasses = function (day, index) {
        var classes = {
            'day-overview ': true,
    ...
    Datepicker.prototype.isInMonth = function (day, week) {
    ...
    Datepicker.prototype.isCurrentDay = function (day) {
        var today = new Date(new Date().setHours(0, 0, 0, 0));
        return day.getTime() === today.getTime();
    };
    Datepicker.prototype.isSameDate = function () {
