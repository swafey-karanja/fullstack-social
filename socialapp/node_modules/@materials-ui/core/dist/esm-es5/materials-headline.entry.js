...
var Headline = /** @class */ (function () {
    ...
    Headline.prototype.getClasses = function () {
        var classes = { 'mdc-typography': true };
        classes['mdc-typography--headline' + this.level] = true;
        return classes;
    };
    Headline.prototype.render = function () {
        return (h("header", { class: this.getClasses() }, h("slot", null)));
    };
    Object.defineProperty(Headline, "style", {
...
export { Headline as materials_headline };
