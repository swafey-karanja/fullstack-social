...
var DatatableBodyRow = /** @class */ (function () {
    function DatatableBodyRow(hostRef) {
        registerInstance(this, hostRef);
        this.selected = false;
        this.selectRow = createEvent(this, "selectRow", 7);
        this.expand = createEvent(this, "expand", 7);
    }
    DatatableBodyRow.prototype.watchSelected = function () {
        this.selectRow.emit(this.selected);
    };
    DatatableBodyRow.prototype.handleClick = function () {
        if (this.selectable) {
            this.selected = !this.selected;
        }
    };
    DatatableBodyRow.prototype.toggleExpendable = function (e) {
        e.stopPropagation();
        this.expended = !this.expended;
        this.expand.emit(this.expended);
    };
    DatatableBodyRow.prototype.render = function () {
        var _this = this;
        return h(Host, { class: {
                'dense': this.dense,
            ...
            }, onClick: function () { return _this.handleClick(); } }, h("div", { class: "container" }, h("div", { class: "mdc-ripple-surface mdc-ripple-surface--primary" }), this.expendable &&
            h("materials-icon-button", { dense: true, icon: this.expended ? 'arrow_drop_down' : 'arrow_right', onClick: function (e) { return _this.toggleExpendable(e); } }), this.selectable &&
            h("materials-checkbox", { class: "selection-checkbox", color: "primary", onChange: function () {
                    _this.selected = !_this.selected;
                }, onClick: function (e) { return e.stopPropagation(); }, checked: this.selected }), h("slot", null)), h("div", { class: "expendable-content" }, h("slot", { name: "expendable-content" })));
    };
    Object.defineProperty(DatatableBodyRow.prototype, "host", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(DatatableBodyRow, "watchers", {
        get: function () {
            return {
