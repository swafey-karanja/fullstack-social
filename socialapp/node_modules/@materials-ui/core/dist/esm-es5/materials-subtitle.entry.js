...
var Subtitle = /** @class */ (function () {
    function Subtitle(hostRef) {
        registerInstance(this, hostRef);
    }
    Subtitle.prototype.getClasses = function () {
        var classes = { 'mdc-typography': true };
        classes['mdc-typography--subtitle' + this.level] = true;
        return classes;
    };
    Subtitle.prototype.render = function () {
        return (h("div", { class: this.getClasses() }, h("slot", null)));
    };
    Object.defineProperty(Subtitle, "style", {
...
export { Subtitle as materials_subtitle };
