...
var TopAppBar = /** @class */ (function () {
    function TopAppBar(hostRef) {
        registerInstance(this, hostRef);
        this.toggleMenu = createEvent(this, "toggleMenu", 7);
    }
    TopAppBar.prototype.componentWillLoad = function () {
        this.actions = Array.from(this.host.querySelectorAll('materials-top-app-bar-action'));
    };
    TopAppBar.prototype.componentDidLoad = function () {
        var _this = this;
        this.topAppBarElement = this.host.querySelector('.mdc-top-app-bar');
        var topAppBar = MDCTopAppBar.attachTo(this.topAppBarElement);
        topAppBar.listen('MDCTopAppBar:nav', function () {
            _this.toggleMenu.emit();
        });
    };
    TopAppBar.prototype.getTopAppBarClasses = function () {
        return {
