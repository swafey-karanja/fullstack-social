...
import { M as MDCFloatingLabel, b as MDCNotchedOutline, a as MDCLineRipple } from './component-53000c01.js';
import { M as MDCTextField, a as MDCTextFieldHelperText, b as MDCTextFieldIcon } from './index-7f2b9f47.js';
...
const TextField = class {
    constructor(hostRef) {
        ...
        this.trailingIconPress = createEvent(this, "trailingIconPress", 7);
        this.leadingIconPress = createEvent(this, "leadingIconPress", 7);
    }
    componentWillLoad() {
        if (!this.value) {
            this.value = '';
    ...
    render() {
        return (h(Host, { class: { 'materials-text-field--dense': this.dense } }, h("div", { style: { 'width': this.width ? (this.width + 'px') : '100%' }, class: this.getClasses(), ref: mdcTextField => this.textFieldEl = mdcTextField }, this.leadingIcon &&
            h("i", { class: "materials-leading-icon material-icons mdc-text-field__icon", title: this.leadingIconTitle, onClick: (ev) => this.leadingIconPress.emit(ev), tabindex: "0", role: "button" }, this.leadingIcon), h("input", { id: "my-text-field", class: { 'mdc-text-field__input': true, 'hide-native-clear': this.hideNativeClear, 'mdc-text-field--overflow-elipsis': this.overflow }, type: this.type, pattern: this.pattern, value: this.value, disabled: this.disabled, required: this.required, readonly: this.readonly, name: this.name, maxlength: this.maxlength, ref: el => this.inputEl = el, onInput: (ev) => {
                this.value = ev.target.value;
                this.input.emit(ev);
            }, onChange: (ev) => this.change.emit(ev) }), this.trailingIcon &&
            h("i", { onClick: (ev) => this.trailingIconPress.emit(ev), class: "materials-trailing-icon material-icons mdc-text-field__icon", title: this.trailingIconTitle, tabindex: "0", role: "button" }, this.trailingIcon), this.outlined ?
            h("div", { class: "mdc-notched-outline", ref: notchedOutlineEl => this.notchedOutlineEl = notchedOutlineEl }, h("div", { class: "mdc-notched-outline__leading" }), h("div", { class: "mdc-notched-outline__notch" }, this.label && h("label", { class: this.getLabelClasses(), ref: el => this.floatingLabelEl = el }, this.label)), h("div", { class: "mdc-notched-outline__trailing" }))
            : this.label && h("label", { class: this.getLabelClasses(), ref: el => this.floatingLabelEl = el }, this.label), this.outlined ? '' : h("div", { class: "mdc-line-ripple", ref: el => this.lineRippleEl = el })), h("div", { class: "mdc-text-field-helper-line" }, h("div", { id: "helper-text", class: { 'mdc-text-field-helper-text': true }, "aria-hidden": "true", ref: el => this.helperTextEl = el }))));
    }
...
export { TextField as materials_text_field };
