...
const DrawerWithTopAppBar = class {
    ...
    renderAppBar() {
        ...
        return (h("header", { class: classes, id: "app-bar" }, h("div", { class: "mdc-top-app-bar__row" }, h("section", { class: "mdc-top-app-bar__section mdc-top-app-bar__section--align-start" }, h("a", { class: "demo-menu material-icons mdc-top-app-bar__navigation-icon" }, "menu"), h("span", { class: "mdc-top-app-bar__title" }, this.appBarTitle)), h("section", { class: "mdc-top-app-bar__section mdc-top-app-bar__section--align-end", role: "toolbar" }, this.actions.map(a => h("a", { href: "#", onClick: () => a.click(), class: "material-icons mdc-top-app-bar__action-item", "aria-label": a.title, title: a.title }, a.icon))))));
    }
    renderDrawerItem(item) {
        return h("a", { class: {
                'mdc-list-item': true,
                'mdc-list-item--activated': item.activated
            }, href: item.targetUrl, onClick: (e) => { item.TriggerPress(e); }, "aria-current": "page" }, item.icon && h("i", { class: "material-icons mdc-list-item__graphic", "aria-hidden": "true" }, item.icon), h("span", { class: "mdc-list-item__text" }, item.label));
    }
    renderModal() {
        return [
            this.renderAppBar(),
            h("aside", { class: "mdc-drawer mdc-drawer--modal" }, h("div", { class: "mdc-drawer__content" }, h("nav", { class: "mdc-list" }, this.items.map(item => this.renderDrawerItem(item))))),
    ...
    renderFull() {
        return [
            h("aside", { class: "mdc-drawer mdc-drawer--dismissible" }, h("div", { class: "mdc-drawer__content" }, h("div", { class: "mdc-list" }, this.items.map(item => this.renderDrawerItem(item))))),
    ...
    renderBelow() {
        return [
            this.renderAppBar(),
            h("aside", { class: "mdc-drawer mdc-drawer--dismissible mdc-top-app-bar--fixed-adjust" }, h("div", { class: "mdc-drawer__content" }, h("div", { class: "mdc-list" }, this.items.map(item => this.renderDrawerItem(item))))),
