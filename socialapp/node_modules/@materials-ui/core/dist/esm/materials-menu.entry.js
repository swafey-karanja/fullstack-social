...
import { M as MDCMenu, C as Corner } from './component-427801f6.js';
...
const Menu = class {
    ...
    render() {
        return (h(Host, null, h("style", null, this.maxHeight && `
            .mdc-menu{
              max-height: ${this.maxHeight}px!important;
            }
          `), h("div", { class: "mdc-menu-surface--anchor" }, h("div", { class: "mdc-menu mdc-menu-surface", ref: el => { this.menuEl = el; } }, h("ul", { class: { 'mdc-list': true, 'no-padding': this.noPadding }, role: "menu", "aria-hidden": "true", "aria-orientation": "vertical" }, h("slot", null))))));
    }
