...
const ListItem = class {
    ...
    render() {
        return (h(Host, { onClick: () => this.handleClick() }, h("li", { class: this.getClasses(), style: this.setHeight(), role: this.role, tabindex: this.disabled ? -1 : 0, "aria-disabled": this.disabled }, h("div", { class: "mdc-list-item__graphic", style: this.itemStartStyle }, h("slot", { name: "item-start" })), this.label && h("label", { class: { 'gmv-label-nowrap': !this.textWrap }, title: this.label }, this.label), h("slot", null), h("div", { class: "mdc-list-item__meta", style: this.itemEndStyle }, h("slot", { name: "item-end" })))));
    }
...
export { ListItem as materials_list_item };
