...
const DatatableBodyRow = class {
    ...
    render() {
        return h(Host, { class: {
            ...
            }, onClick: () => this.handleClick() }, h("div", { class: "container" }, h("div", { class: "mdc-ripple-surface mdc-ripple-surface--primary" }), this.expendable &&
            h("materials-icon-button", { dense: true, icon: this.expended ? 'arrow_drop_down' : 'arrow_right', onClick: (e) => this.toggleExpendable(e) }), this.selectable &&
            h("materials-checkbox", { class: "selection-checkbox", color: "primary", onChange: () => {
                    this.selected = !this.selected;
                }, onClick: (e) => e.stopPropagation(), checked: this.selected }), h("slot", null)), h("div", { class: "expendable-content" }, h("slot", { name: "expendable-content" })));
    }
