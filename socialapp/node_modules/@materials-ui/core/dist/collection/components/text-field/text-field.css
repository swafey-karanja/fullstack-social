...
.mdc-text-field {
  border-radius: var(--mdc-theme-text-field-filled-radius, 4px) var(--mdc-theme-text-field-filled-radius, 4px) 0 0;
}

.mdc-text-field.mdc-text-field--outlined .mdc-notched-outline__leading {
  border-radius: var(--mdc-theme-text-field-outlined-radius, 4px) 0 0 var(--mdc-theme-text-field-outlined-radius, 4px);
}
.mdc-text-field.mdc-text-field--outlined .mdc-notched-outline__trailing {
  border-radius: 0 var(--mdc-theme-text-field-outlined-radius, 4px) var(--mdc-theme-text-field-outlined-radius, 4px) 0;
}

.mdc-text-field--overflow-elipsis {
  text-overflow: ellipsis;
}

:host(.materials-text-field--dense) .mdc-text-field {
  transform: scale(0.8);
  transform-origin: 0% 0;
}
:host(.materials-text-field--dense) .mdc-text-field .mdc-floating-label {
  font-size: 1.25rem;
}
:host(.materials-text-field--dense) .mdc-text-field .mdc-select__native-control {
  font-size: 1.25rem;
}
:host(.materials-text-field--dense) .mdc-text-field-helper-line {
  transform: translateY(-50%);
}

.hide-native-clear::-webkit-datetime-edit-text {
  padding: 0 0.3em;
}

.hide-native-clear::-webkit-inner-spin-button {
  display: none;
}

.hide-native-clear::-webkit-clear-button,
.hide-native-clear::-ms-clear {
  display: none !important;
}

.hide-native-clear::-webkit-calendar-picker-indicator {
  display: none;
  -webkit-appearance: none;
}